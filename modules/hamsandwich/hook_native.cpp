...
hook_t hooklist[] =
{
	...
	{ V("sc_shouldfadeondeath",		Bool_Void) },
	{ V("sc_setupfriendly",			Void_Void) },
	{ V_REMOVED("sc_revivethink") },
	{ V("sc_revive",				Void_Void) },
	{ V("sc_startmonster",			Void_Void) },
	{ V("sc_checkrangeattack1_move",Bool_Float_Float) },
	{ V("sc_checkrangeattack2_move",Bool_Float_Float) },
	{ V("sc_checkmeleeattack1_move",Bool_Float_Float) },
	{ V("sc_checkmeleeattack2_move",Bool_Float_Float) },
	{ V("sc_checktankusage",		Bool_Void) },
	{ V("sc_setgaitactivity",		Void_Int) },
	{ V("sc_ftriangulate",			Bool_pVector_pVector_Float_Cbase_pVector_pVector_Bool) },
	{ V("sc_ftriangulateextension",	Bool_pVector_pVector_Float_Cbase_pVector) },
	{ V("sc_findcovergrenade",		Bool_Vector_Vector_Float_Float) },
	{ V("sc_findcoverdistance",		Bool_Vector_Vector_Float_Float) },
	{ V("sc_findattackpoint",		Bool_Vector_Vector_Float_Float) },
	{ V("sc_fvalidatecover",		Bool_pVector) },
	{ V("sc_nofriendlyfire1",		Bool_Void) },
	{ V("sc_nofriendlyfire2",		Bool_Vector) },
	{ V("sc_nofriendlyfire3",		Bool_Vector_Cbase) },
	{ V("sc_nofriendlyfiretopos",	Bool_Vector) },
	{ V("sc_fvisiblegunpos",		Bool_Cbase_pVector) },
	{ V("sc_finbulletcone",			Bool_Cbase_pVector) },
	{ V("sc_callgibmonster",		Void_Void) },
	{ V("sc_checktimebaseddamage",	Void_Void) },
	{ V("sc_ismoving",				Bool_Void) },
	{ V("sc_isplayerfollowing",		Bool_Void) },
	...
	{ V("sc_mediccallsound",		Void_Float) },
	...
	{ V("sc_weapon_bulletaccuracy",	Vector_pVector_pVector_pVector) },
	...
	{ V("sc_giveammo", Int_Int_Str_Int_Bool_Int) },
	{ V("sc_checkattacker", Bool_Cbase) },
	...
	{ V("sc_canplaysentence",		Bool_Bool) },
	...
	{ V("sc_weapon_extractammo",	Bool_Cbase) },
	{ V("sc_weapon_extractclipammo",Bool_Cbase) },
	{ V("sc_hashumangibs",			Bool_Void) },
	{ V("sc_hasaliengibs",			Bool_Void) },
	{ V("sc_becomedead",			Void_Float) },
	{ V("sc_irelationship",			Int_Cbase_Bool) },
	{ V("sc_finviewcone",			Bool_Cbase) },
	{ V("sc_fvecinviewcone",		Bool_pVector) },
	{ V("sc_checklocalmove",		Int_Vector_Vector_Cbase_pFloat_pVector_Bool) },
	{ V("sc_shouldadvanceroute",	Bool_Float) },
	{ V("sc_checkrangeattack1",		Bool_Float_Float) },
	{ V("sc_checkrangeattack2",		Bool_Float_Float) },
	{ V("sc_checkmeleeattack1",		Bool_Float_Float) },
	{ V("sc_checkmeleeattack2",		Bool_Float_Float) },
	{ V("sc_checkenemy",			Bool_Cbase) },
	{ V("sc_buildnearestroute",		Bool_Vector_Vector_Float_Float) },
	{ V("sc_findcover",				Bool_Vector_Vector_Float_Float) },
	{ V("sc_fcancheckattacks",		Bool_Void) },
	{ V("sc_fvalidatehinttype",		Bool_Short) },
	{ V("sc_fcanactiveidle",		Bool_Void) },
	{ V("sc_barnaclevictimbitten",	Void_Entvar_Float) },
};
